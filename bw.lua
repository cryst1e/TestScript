...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started and not shared.VapeIndependent then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring("https://raw.githubusercontent.com/SkyLi000/TestScript/main/bw.lua")() else loadstring(game:HttpGet("https://raw.githubusercontent.com/SkyLi000/TestScript/main/bw.lua", true))() end'
		if shared.VapeDeveloper then
